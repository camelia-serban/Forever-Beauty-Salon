...
<body>
    ...
    <section class="dashboard" id="dashboard">
            <div class="max-width">
                <!--sidebar-->
                <div id="sidebar">
                    <a href="facialTreatmentDashboard.php" class="brand"><i class='bx bxs-bookmarks icon'></i>Facials Panel</a>
                    <ul class="side-menu">
                        <li><a href="facialTreatmentDashboard.php" class="active"><i class='bx bxs-dashboard icon'></i>Dashboard</a></li>
                        ...
                        <li>
                            ...
                            <ul class="side-dropdown">
                                <li><a href="allAppointmentsFacials.php">All appointments</a></li>
                                <li><a href="newAppointmentsFacials.php">New appointments</a></li>
                                <li><a href="acceptedAppointmentsFacials.php">Accepted appointments</a></li>
                                <li><a href="rejectedAppointmentsFacials.php">Rejected appointments</a></li>
                            </ul>
                        </li>
                        
                        <li class="divider">Account</li>
                        <li><a href="myProfileFacials.php"><i class='bx bx-user-circle icon'></i></i>My profile</a></li>
                    </ul>
                </div>
                ...
                <div id="content">
                    <main>
                        ...
                        <ul class="breadcrumbs">
                            <li><a href="facialTreatmentDashboard.php">Home</a></li>
                            <li class="divider">/</li>
                            <li><a href="facialTreatmentDashboard.php" class="active">Dashboard</a></li>
                        </ul>  
                        ...
                        <div class="info-data">
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query1=mysqli_query($con, "select * from appointments where service in ('Microdermabrasion', 'Chemical peeling')");
                            ...
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query2=mysqli_query($con, "select * from appointments where status='accepted' and service in ('Microdermabrasion', 'Chemical peeling')");
                            ...
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query3=mysqli_query($con, "select * from appointments where status='rejected' and service in ('Microdermabrasion', 'Chemical peeling')");
