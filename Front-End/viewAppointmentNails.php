...
if(isset($_POST['save']))
{
    ...
    if($query){ 
        echo "<script>window.location.href = 'newAppointmentsNails.php'</script>";
    }
    else{
                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <?php
                                        $id=$_POST['edit_id'];
                                        $ret=mysqli_query($con,"select * from  appointments where status='' and service in ('Gel nails', 'Acrylic nails', 'Basic nails') limit 1");
                                        $cnt=1;
