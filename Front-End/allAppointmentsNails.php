...
<body>
    ...
    <section class="dashboard" id="dashboard">
            <div class="max-width">
                <!--sidebar-->
                <div id="sidebar">
                    <a href="nailsDashoard.php" class="brand"><i class='bx bxs-bookmarks icon'></i>Nails Panel</a>
                    <ul class="side-menu">
                        <li><a href="nailsDashoard.php" class="active"><i class='bx bxs-dashboard icon'></i>Dashboard</a></li>
                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                        $ret=mysqli_query($con, "select * from appointments where service in ('Gel nails', 'Acrylic nails', 'Basic nails')");
                                        $cnt=1;
