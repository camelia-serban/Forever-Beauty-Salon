                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <?php
                                            $ret=mysqli_query($con,"select * from  appointments where status='' and service in ('Microdermabrasion', 'Chemical peeling')");
                                            $cnt=1;
                                    ...
                                    <tbody>                                        
                                            ...
                                            <tr>  
                                                ...
                                                <td><a style="text-decoration:none; color:teal;" href="viewAppointmentFacials.php" class="edit_data" id="<?php echo $row['id']; ?>"title="click for edit">View</a></td>                                                                     
                                            </tr>   
                                            <?php 
                                            $cnt=$cnt+1;
                                            }?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(document).on('click', '.edit_data', function(){
                ...
                $.ajax({
                    url:"viewAppointmentFacials.php",
                    type:"post",
