...
<body>
    ...
    <section class="dashboard" id="dashboard">
            <div class="max-width">
                <!--sidebar-->
                <div id="sidebar">
                    <a href="hairDashboard.php" class="brand"><i class='bx bxs-bookmarks icon'></i>Hair Panel</a>
                    <ul class="side-menu">
                        <li><a href="hairDashboard.php" class="active"><i class='bx bxs-dashboard icon'></i>Dashboard</a></li>
                        ...
                        <li>
                            ...
                            <ul class="side-dropdown">
                                <li><a href="allAppointmentsHair.php">All appointments</a></li>
                                <li><a href="newAppointmentsHair.php">New appointments</a></li>
                                <li><a href="acceptedAppointmentsHair.php">Accepted appointments</a></li>
                                <li><a href="rejectedAppointmentsHair.php">Rejected appointments</a></li>
                            </ul>
                        </li>
                        
                        <li class="divider">Account</li>
                        <li><a href="myProfileHair.php"><i class='bx bx-user-circle icon'></i></i>My profile</a></li>
                    </ul>
                </div>
                ...
                <div id="content">
                    <main>
                        ...
                        <ul class="breadcrumbs">
                            <li><a href="hairDashboard.php">Home</a></li>
                            <li class="divider">/</li>
                            <li><a href="hairDashboard.php" class="active">Dashboard</a></li>
                        </ul>  
                        ...
                        <div class="info-data">
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query1=mysqli_query($con, "select * from appointments where service in ('Hair cutting', 'Chemical straightening', 'Highlights')");
                            ...
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query2=mysqli_query($con, "select * from appointments where status='accepted' and service in ('Hair cutting', 'Chemical straightening', 'Highlights')");
                            ...
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query3=mysqli_query($con, "select * from appointments where status='rejected' and service in ('Hair cutting', 'Chemical straightening', 'Highlights')");
