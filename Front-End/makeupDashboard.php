...
<body>
    ...
    <section class="dashboard" id="dashboard">
            <div class="max-width">
                <!--sidebar-->
                <div id="sidebar">
                    <a href="makeupDashboard.php" class="brand"><i class='bx bxs-bookmarks icon'></i>Makeup Panel</a>
                    <ul class="side-menu">
                        <li><a href="makeupDashboard.php" class="active"><i class='bx bxs-dashboard icon'></i>Dashboard</a></li>
                        ...
                        <li>
                            ...
                            <ul class="side-dropdown">
                                <li><a href="allAppointmentsMakeup.php">All appointments</a></li>
                                <li><a href="newAppointmentsMakeup.php">New appointments</a></li>
                                <li><a href="acceptedAppointmentsMakeup.php">Accepted appointments</a></li>
                                <li><a href="rejectedAppointmentsMakeup.php">Rejected appointments</a></li>
                            </ul>
                        </li>
                        
                        <li class="divider">Account</li>
                        <li><a href="myProfileMakeup.php"><i class='bx bx-user-circle icon'></i></i>My profile</a></li>
                    </ul>
                </div>
                ...
                <div id="content">
                    <main>
                        ...
                        <ul class="breadcrumbs">
                            <li><a href="makeupDashboard.php">Home</a></li>
                            <li class="divider">/</li>
                            <li><a href="makeupDashboard.php" class="active">Dashboard</a></li>
                        </ul>  
                        ...
                        <div class="info-data">
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query1=mysqli_query($con, "select * from appointments where service in ('Evening make-up', 'Bridal make-up')");
                            ...
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query2=mysqli_query($con, "select * from appointments where status='accepted' and service in ('Evening make-up', 'Bridal make-up')");
                            ...
                            <div class="card">
                                <div class="head">
                                    <div>
                                    <?php $query3=mysqli_query($con, "select * from appointments where status='rejected' and service in ('Evening make-up', 'Bridal make-up')");
