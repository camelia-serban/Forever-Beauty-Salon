...
<body>
    ...
    <section class="dashboard" id="dashboard">
            <div class="max-width">
                <!--sidebar-->
                <div id="sidebar">
                    <a href="makeupDashoard.php" class="brand"><i class='bx bxs-bookmarks icon'></i>Make-up Panel</a>
                    <ul class="side-menu">
                        <li><a href="makeupDashoard.php" class="active"><i class='bx bxs-dashboard icon'></i>Dashboard</a></li>
                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                        $ret=mysqli_query($con, "select * from appointments where service in ('Evening make-up', 'Bridal make-up')");
                                        $cnt=1;
