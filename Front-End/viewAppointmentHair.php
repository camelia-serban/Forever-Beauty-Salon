...
if(isset($_POST['save']))
{
    ...
    if($query){ 
        echo "<script>window.location.href = 'newAppointmentsHair.php'</script>";
    }
    else{
                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <?php
                                        $id=$_POST['edit_id'];
                                        $ret=mysqli_query($con,"select * from  appointments where status='' and service in ('Hair cutting', 'Chemical straightening', 'Highlights') limit 1");
                                        $cnt=1;
