...
<body>
    ...
    <section class="dashboard" id="dashboard">
            <div class="max-width">
                <!--sidebar-->
                <div id="sidebar">
                    <a href="makeupDashboard.php" class="brand"><i class='bx bxs-bookmarks icon'></i>Make-up Panel</a>
                    <ul class="side-menu">
                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <?php
                                            $ret=mysqli_query($con,"select * from  appointments where status='' and service in ('Evening make-up', 'Bridal make-up')");
                                            $cnt=1;
                                    ...
                                    <tbody>                                        
                                            ...
                                            <tr>  
                                                ...
                                                <td><a style="text-decoration:none; color:teal;" href="viewAppointmentMakeup.php" class="edit_data" id="<?php echo $row['id']; ?>"title="click for edit">View</a></td>                                                                     
                                            </tr>   
                                            <?php 
                                            $cnt=$cnt+1;
                                            }?>
