...
if(isset($_POST['submit']))
{
    ...
    //$service_cost=$_POST['service_domain'];

    $query=mysqli_query($con, "insert into services(service_name, service_cost)
            value('$service_name', '$service_cost')");
...
<head>
    ...
    <link rel="stylesheet" href="addService_style.css" type="text/css">
                        ...
                        <div class="details">
                            <div class="addService">
                                ...
                                <form method="post" action="#">
                                    <div class="control">
                                        <label for="name">Service Name</label><input type="text" name="service_name" id="service_name">
                                    </div>
                                    <div class="control">
                                        <label for="name">Service Cost</label><input type="text" name="service_cost" id="service_cost">
                                    </div>
                                    <div class="control"><input type="submit" name="submit" value="Create" id="button">
                                    </div> 
                                </form>
