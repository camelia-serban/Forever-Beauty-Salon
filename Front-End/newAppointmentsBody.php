                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <?php
                                            $ret=mysqli_query($con,"select * from  appointments where status='' and service in ('LED light therapy')");
                                            $cnt=1;
                                    ...
                                    <tbody>                                        
                                            ...
                                            <tr>  
                                                ...
                                                <td><a style="text-decoration:none; color:teal;" href="viewAppointmentBody.php" class="edit_data" id="<?php echo $row['id']; ?>"title="click for edit">View</a></td>                                                                     
                                            </tr>   
                                            <?php 
                                            $cnt=$cnt+1;
                                            }?>
