...
<body>
    ...
    <section class="dashboard" id="dashboard">
            <div class="max-width">
                <!--sidebar-->
                <div id="sidebar">
                    <a href="hairDashoard.php" class="brand"><i class='bx bxs-bookmarks icon'></i>Hair Panel</a>
                    <ul class="side-menu">
                        <li><a href="hairDashoard.php" class="active"><i class='bx bxs-dashboard icon'></i>Dashboard</a></li>
                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                        $ret=mysqli_query($con, "select * from appointments where service in ('Hair cutting', 'Chemical straightening', 'Highlights')");
                                        $cnt=1;
