...
if(isset($_POST['save']))
{
    ...
    if($query){ 
        echo "<script>window.location.href = 'newAppointmentsFacials.php'</script>";
    }
    else{
                        ...
                        <div class="details">
                            <div class="allAppointments">
                                ...
                                <table>
                                    ...
                                    <?php
                                        $id=$_POST['edit_id'];
                                        $ret=mysqli_query($con,"select * from  appointments where status='' and service in ('Microdermabrasion', 'Chemical peeling') limit 1");
                                        $cnt=1;
