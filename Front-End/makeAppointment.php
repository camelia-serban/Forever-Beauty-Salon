...
<head>
    ...
    <link rel="stylesheet" href="makeAppointment_style.css" type="text/css">
    ...
    <section class="make-appointment" id="appointment">
        <div class="max-width">
            <div class="appointment-content">
                <div class="text">You need to <span><a href="login.php">LOGIN</a></span> in order to make an appointment.</div>
                <div class="text">If you don't have an account <span><a href="signup.php">CREATE</a></span> one here.</div>
            </div>
        </div>
    </section>
